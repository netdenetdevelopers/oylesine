    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib")
                ...
                //.Include(lte + "js/mytour/jquery.1.7.1.js")
                .Include(lte + "js/mytour/jquery.mytour.1.0.7.min.js")
                ...
                .Include(lteplugins + "input-mask/jquery.inputmask.phone.extensions.js")
                .Include(lteplugins + "input-mask/jquery.inputmask.extensions.js")
                .Include(lteplugins + "input-mask/jquery.inputmask.regex.extensions.js")
                .Include(lteplugins + "input-mask/jquery.inputmask.numeric.extensions.js")
                ...
                .Include(ltecomponents + "select2/dist/js/select2.min.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css")
                ...
                .Include("~/Content/ProgressBarWindows.css")
